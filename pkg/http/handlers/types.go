...
//
//    temperatures, err := UnmarshalGithubWebhookBody(bytes)
//    bytes, err = temperatures.Marshal()

package handlers

import "encoding/json"

func UnmarshalGithubWebhookBody(data []byte) (GithubWebhookBody, error) {
	var r GithubWebhookBody
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *GithubWebhookBody) Marshal() ([]byte, error) {
