Welcome to Mergebot (together with the services available therein, the "Site") and any web applications or mobile application and tools we may offer (together with the Site, the "Service").
